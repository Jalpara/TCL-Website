        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-4">
             <div className="flex items-center gap-3 mb-6">
                <Image src="/assets/WhiteLogo.png" alt="The Connecting Link Logo" width={300} height={100} className="h-20 md:h-20 w-auto invert grayscale" referrerPolicy="no-referrer" />
             </div>
